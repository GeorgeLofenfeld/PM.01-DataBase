...
wchar_t** Database_meetings_record::to_string(int is_file_format)
{
	...
	if (permitted)
		wcscpy(strings[6], L"ДА");
	else
		wcscpy(strings[6], L"НЕТ");
	return strings;
}
...
wchar_t** Database_offences_record::to_string(int is_file_format)
{
	...
	if (conviction_flag)
		wcscpy(strings[4], L"ДА");
	else
		wcscpy(strings[4], L"НЕТ");
	return strings;
}
...
wchar_t** Database_declarers_record::to_string(int is_file_format)
{
	...
	if (has_offenses_flag)
		wcscpy(strings[1], L"ДА");
	else
		wcscpy(strings[1], L"НЕТ");
	return strings;
}
